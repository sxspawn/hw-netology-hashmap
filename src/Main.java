    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (Character.isLetter(currentChar)) {
                ...
                if (!charFrequency.containsKey(currentChar)) {
                    ...
                    int currentFrequency = charFrequency.get(currentChar);
                    charFrequency.put(currentChar, currentFrequency + 1);
                }
            }
        }
        ...
        for (Map.Entry<Character, Integer> entry : charFrequency.entrySet()) {
            ...
            if (currentFrequency < minFrequency) {
                ...
                leastFrequentChar = currentChar;
            }
        }
        System.out.println("Чаще всего встречается символ '" +
                mostFrequentChar + "' - " + maxFrequency + " раз(а).");
        System.out.println("Реже всего встречается символ '" +
                leastFrequentChar + "' - " + minFrequency + " раз(а).");
    }
}